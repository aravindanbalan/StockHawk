...
public class StockDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        emptyTextView = (TextView) rootView.findViewById(R.id.details_emptyView);
        ...
        mStockDetails = (FrameLayout)  rootView.findViewById(R.id.stock_details);
    ...
    public void onEventMainThread(QuoteHistoryEvent event) {
        if (!event.isError) {
            ...
            //Error occured while fetching history data
            emptyTextView.setText(getString(R.string.data_error_json));
